...
public class FormValidator {
    public static UserDAO daoh = new UserDAOH();
    ...
    public static Map<String, Object> checkDataforRegistrationForm(String login, String password,
        ...
        //check existed login in db DAOFactory.getInstance(1).getUserDAO().getUserByLogin(user.getLogin())
        if (!isError) {
            if (daoh.getUserByLogin(user.getLogin()) != null) {
                isError = true;
