                    ...
                    <div class="desc1 span_3_of_2">
                        ...
                        <div class="det_nav1">
                            ...
                            <div class="quantity-block">
                                <button class="quantity-arrow-minus" id="imgMinus" onclick="minus(${productById.id})">
                                    -
                                </button>
                                <span class="raz" id="span">1</span>
                                <button class="quantity-arrow-plus" id="imgPlus" onclick="plus(${productById.id})"> +
                                </button>
                            </div>

                        </div>
                        <div class="btn_form">
                            <a onMouseDown="addToCart(${productById.id})"
                               href="${pageContext.servletContext.contextPath}/cart">buy</a>
                        </div>
