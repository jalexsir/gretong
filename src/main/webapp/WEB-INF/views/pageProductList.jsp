                    ...
                    <c:forEach begin="0" end="${(fourIndex==0)?3:(i==newEndIndex)?fourIndex-1:3}">
                        <div class="grid1_of_4" ${counter=counter+1}>
                            <div class="content_box"><a
                                    href="${pageContext.servletContext.contextPath}/product/detail/${productList.get(counter).id}">
                                <img src="${pageContext.servletContext.contextPath}/resources/images/w${productList.get(counter).id}.jpg"
